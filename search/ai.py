...
class Model_Generator():
    ...
    def feat_image(self, filename=None):
        ...
        sd_negative_prompt = 'codeugly, tiling, out of frame, extra limbs, disfigured, deformed, body out of frame, bad anatomy, watermark, signature, cut off, low contrast, underexposed, overexposed, distorted face'
