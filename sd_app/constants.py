...
default_title_prompt = "Write a simple title for a captivating site about songs about [keyword]. Only output the title, nothing else."
default_title_prompt_artist = "Write a simple title for a captivating site about songs from [artist]. Only output the title, nothing else."
